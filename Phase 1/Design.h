/*
    - Plan:
        ...
        3. The Schedular Algo(ex:HPF,RR):
            ...
            7- When the process send a signal that it finished 1 clk, the scheduler decide will it continue or block it.
                Note that when remaining time of the process is 0 the scheduler doesn't do ant thing to the process.
            8- all functions used by the scheduler alorithms is in algorithms_functions.h        
    ...
    - Signals:
        ...
        2. From the process to the scheduler to inform that it executed for 1 clk 
        3. From the process to the schedular algo:When the process finishes executing, it sends a signal to the schedular algo to inform it. 
